...
//        }
        ...
        mReaderOrientation.bindPreference(getChildFragmentManager(), this, PreferenceManager.PREF_READER_STREAM_ORIENTATION,
                PreferenceManager.READER_ORIENTATION_AUTO, R.array.reader_orientation_items, DIALOG_REQUEST_ORIENTATION);
        mReaderTurn.bindPreference(getChildFragmentManager(), this, PreferenceManager.PREF_READER_STREAM_TURN,
